...
$count=0;
$sql="select *from bus,route where route.bid=bus.bid  and route.fromLoc='$from ' and route.toLoc= '$to' and route.dep_date='$date ' ORDER BY route.fare ASC ";
...
<input type="radio" name="mode" value="1"><font face="Arial" font size="4" color="black">DBBL (Rocket)</font><br>
